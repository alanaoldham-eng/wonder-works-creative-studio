...
<div className="character-detail"><Image src="/images/story/elena-valley.jpg" alt="Elena Rostova looking out over the snow-covered Hessdalen Valley at night" width={825} height={714}/><div><h2>Seeker of patterns</h2><p>Elena approaches the unexplained through evidence, disciplined observation, and a deep respect for what remains unknown. Her journey tests whether understanding can come from distance alone.</p><p>This page will expand with spoiler-conscious character material as publication approaches.</p><Link className="secondary-link" href="/projects/when-the-lights-knock">Return to the book</Link></div></div>
</PageShell>}
